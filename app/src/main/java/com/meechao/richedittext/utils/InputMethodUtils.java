package com.meechao.richedittext.utils;
...
public class InputMethodUtils {
    ...
    public static void detectKeyboard(RichActivity activity) {
     ...
     */
    public static void detectKeyboard(final RichActivity activity, final OnKeyboardEventListener listener) {
